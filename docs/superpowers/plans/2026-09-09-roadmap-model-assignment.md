...
| C | `2026-09-09-phase-C-reliability.md` | leak self-test, health watch, DoH bootstrap, gateway watch, firewall holes, sing-box DNS, two-core chains, Linux/mac guard | v1.7.0 |
...
| E | `2026-09-09-phase-E-android.md` | Android parity: managed DNS, `dns=` links, advancedUseMode | v1.8.0 |
