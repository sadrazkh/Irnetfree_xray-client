...
const I18N = {
  fa: {
    ...
    'edit.engineHint': 'فقط همین کانفیگ روی هستهٔ انتخابی اجرا می‌شود. هستهٔ Spoof به باینری‌اش در bin/ نیاز دارد؛ نبود، به Xray برمی‌گردد.',
    'engine.xray': 'Xray (پیش‌فرض)', 'engine.spoof': 'هستهٔ Spoof (ClientHello/SNI جعلی)',
  ...
  en: {
    ...
    'edit.engineHint': 'Only this config runs on the chosen core. The spoof core needs its binary in bin/; falls back to Xray if missing.',
    'engine.xray': 'Xray (default)', 'engine.spoof': 'Spoof core (fake ClientHello / SNI)',
