...
const I18N = {
  fa: {
    ...
    'edit.pattTitle': '🧩 patterniha — finalMask / cipherSuites',
    'edit.cipherSuites': 'cipherSuites (همراه با fingerprint = unsafe)',
    'edit.finalMask': 'finalMask (JSON)',
    'edit.pattHint': 'روش patterniha: Address را یک IP تمیزِ کلودفلر بگذار، fingerprint = unsafe، بعد cipherSuites و finalMask را بچسبان. آرایه‌های lengths/delays خودکار نرمال می‌شوند تا روی هستهٔ فعلی کار کنند.',
    ...
    'spoof.fakeSni': 'SNI جعلیِ فریب (آزمایشی — نیازمند هستهٔ سازگار)',
    'spoof.fakeSniHint': 'یک ClientHello جعلی با این دامنه پیش از هندشیک واقعی تزریق می‌کند تا DPI دامنهٔ مجاز را ببیند. اگر کانفیگ وصل نشد، خالی‌اش کن.',
    ...
    'engine.xray': 'Xray (پیش‌فرض)', 'engine.singbox': 'sing-box (ClientHello جعلی / uTLS)',
  ...
  en: {
    ...
    'edit.finalMask': 'finalMask (JSON)',
    'edit.pattHint': 'patterniha method: set Address to a clean Cloudflare IP, fingerprint = unsafe, then paste cipherSuites and finalMask. Array lengths/delays are auto-normalized to run on the bundled core.',
    ...
    'spoof.fakeSni': 'Fake SNI decoy (experimental — needs a compatible core)',
    'spoof.fakeSniHint': 'Injects a fake ClientHello with this domain before the real handshake so DPI sees the allowed name. If the config stops connecting, clear it.',
    ...
    'engine.xray': 'Xray (default)', 'engine.singbox': 'sing-box (fake ClientHello / uTLS)',
