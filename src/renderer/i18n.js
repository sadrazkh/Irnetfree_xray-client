...
const I18N = {
  fa: {
    ...
    'spoof.frontTitle': '🛡 CDN فرانتینگ / جعل SNI',
    'spoof.frontSni': 'Front SNI — دامنهٔ مجاز (سانسورچی و CDN همین را می‌بینند)',
    'spoof.frontHost': 'Host — بک‌اند واقعی تو (پشت CDN)',
    'spoof.frontHint': '«Address» = همان CDN که وصل می‌شوی (IP اینجاست). «Front SNI» = یک دامنهٔ مجاز روی همان CDN — این تنها SNI است؛ هم سانسورچی و هم CDN آن را می‌بینند. «Host» = بک‌اند واقعی تو. برای پنهان‌کردن همین SNI از DPI، پایین Fragment را روشن کن.',
  ...
  en: {
    ...
    'spoof.frontTitle': '🛡 CDN fronting / SNI spoofing',
    'spoof.frontSni': 'Front SNI — allowed domain (censor + CDN see this)',
    'spoof.frontHost': 'Host — your real backend (behind the CDN)',
    'spoof.frontHint': 'Address = the CDN you connect to (the IP goes here). Front SNI = an allowed domain on that CDN — this is the only SNI; both the censor and the CDN see it. Host = your real backend. To also hide this SNI from DPI, enable Fragment below.',
