...
const I18N = {
  fa: {
    ...
    'tunapp.needsSingbox': '⚠ فقط با بک‌اند sing-box کار می‌کند؛ tun2socks برنامه‌ی صاحب بسته را نمی‌شناسد.',
  ...
  en: {
    ...
    'tunapp.needsSingbox': '⚠ Works only with the sing-box backend; tun2socks cannot tell which app owns a packet.',
