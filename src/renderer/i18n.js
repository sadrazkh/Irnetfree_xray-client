...
const I18N = {
  fa: {
    ...
    'skin.cockpit': 'کاکپیت (پیش‌فرض)', 'skin.console': 'کنسول', 'skin.legacy': 'کلاسیک (نسخه‌های پیشین)',
  ...
  en: {
    ...
    'tb.online': 'ONLINE', 'tb.offline': 'OFFLINE', 'tb.wait': 'LINKING',
    'set.skin': 'Look',
    'skin.cockpit': 'Cockpit (default)', 'skin.console': 'Console', 'skin.legacy': 'Classic (pre-1.0)',
